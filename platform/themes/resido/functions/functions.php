...
if (!function_exists('get_properties_last_four')) {
    /**
     * @return object
     */
    function get_properties_last_four($limit = 4): object
    {
        $params = [
            'condition' => [],
            'take'        => $limit,
...
// // start edit by magh get_post_last_four
// if (!function_exists('get_post_last_four')) {
//     /**
//      * @return object
//      */
//     function get_post_last_four($limit = 4): object
//     {
//         $params = [
//             'condition' => [],
//             'take'        => $limit,
...
//         $params['withCount'] = $withCount;
//         return app(BlogInterface::class)->advancedGet($params);
//     }
// }
