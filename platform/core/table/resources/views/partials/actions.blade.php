<div class="table-actions">
    {!! $extra !!}
    @if (!empty($edit) && $edit !== "consult.edit" )
    ...
    @if ($edit == "consult.edit" )
        @if (Auth::user()->hasPermission($edit))
            <a href="{{ route($edit, $item->id) }}" class="btn btn-icon btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-original-title="{{ trans('core/base::tables.edit') }}"><i class="fa fa-eye"></i></a>
        @endif
    @endif
