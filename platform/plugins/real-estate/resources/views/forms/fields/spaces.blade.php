...
<div class="form-control" style=" border:none; padding-left: 0;">
    ...
    <script type="text/javascript">
        $(document).on("click",".btn-clone-spaces-item",function(){
        ...
        $(document).on("click",".btn-clone-spaces-item-delete",function(e){
            e.preventDefault();
    ...
    <div class="list_multifields">
        <div class="field_headings">
            <div class="row">
                ...
                <div class="col-lg-3"><span>Available Now</span></div>
                <div class="col-lg-2"><span>Price</span></div>
                <div class="col-lg-1"><span>&nbsp;</span></div>
            </div>
        </div>    
        <div class="list-cloned-items" id="listSpaces">
            @foreach($options['values'] as $idx => $val)


            <div class="item row">
                <div class="col-lg-5">  
                    <input type="text" class="field" name="spaces[{{$idx}}][name]" value="{{$val['name']}}" />
                </div>
                <div class="col-lg-3">
                    <input type="number" class="field" name="spaces[{{$idx}}][available]" value="{{$val['available']}}" />
                </div>
                <div class="col-lg-2">
                    <input type="number" step=".01" class="field" name="spaces[{{$idx}}][price]" value="{{$val['price']}}" />
                </div>
                <div class="col-lg-2">
                    <a class="btn-clone-spaces-item-delete"><i class="fa fa-trash btn-remove"></i></a>
                </div>
            </div>
            @endforeach
            <div class="clone row d-none">
                <div class="col-lg-5">  
                    <input type="text" class="field" disabled="disabled" name="spaces[X][name]" />
                </div>
                <div class="col-lg-3">
                    <input type="number" class="field" disabled="disabled" name="spaces[X][available]" value="" />
                </div>
                <div class="col-lg-2">
                    <input type="number" step=".01" class="field" disabled="disabled" name="spaces[X][price]" value="0.00" />
                </div>
                <div class="col-lg-2">
                    <a class="btn-clone-spaces-item-delete"><i class="fa fa-trash btn-remove"></i></a>
                </div>
        ...
        <button type="button" style="margin-left: 10px;" class="btn btn-success btn-clone-spaces-item" data-target="listSpaces" data-index="[X]">Add New</button>
    </div>  
