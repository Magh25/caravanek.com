...
use Botble\RealEstate\Models\Addon;
...
/*<New>*/
use Botble\RealEstate\Repositories\Caches\FeatureGroupsDecorator;
use Botble\RealEstate\Repositories\Caches\AddonDecorator;
use Botble\RealEstate\Repositories\Caches\CommentCacheDecorator;
/*</New>*/
...
/*<New>*/
use Botble\RealEstate\Repositories\Eloquent\FeatureGroupsRepository;
use Botble\RealEstate\Repositories\Eloquent\AddonRepository;
use Botble\RealEstate\Repositories\Eloquent\CommentRepository;
/*</New>*/
...
class RealEstateServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind(FeatureGroupsInterface::class, function () {
            return new FeatureGroupsDecorator(
                new FeatureGroupsRepository(new FeatureGroups)
            );
        });
        // AddonController
        $this->app->bind(AddonInterface::class, function () {
            return new AddonDecorator(
                new AddonRepository(new Addon)
            );
        });
        ...
        $this->app->bind(CommentInterface::class, function () {
            return new CommentCacheDecorator(
    ...
    public function boot()
    {
        ...
        SlugHelper::registerModule(Category::class, 'Property Categories');
        ...
        Event::listen(RouteMatched::class, function () {
            dashboard_menu()
                ...
                ->registerItem([
                    ...
                    'priority'    => 7,
                    'parent_id'   => null,
                    'name'        => 'plugins/real-estate::commission.name',
                ...
                ->registerItem([
                    ...
                    'priority'    => 5,
                    'parent_id'   => 'cms-plugins-real-estate',
                    'name'        => 'plugins/real-estate::feature_groups.name',
                    'icon'        => null,
                    'url'         => route('feature_groups.index'),
                    'permissions' => ['feature_groups.index'],
                ]) 
                // ->registerItem([
                //     'id'          => 'cms-real-estate-addon',
                //     'priority'    => 5,
                //     'parent_id'   => 'cms-plugins-real-estate',
                //     'name'        => 'plugins/real-estate::addon.name',
                //     'icon'        => null,
                //     'url'         => route('addon.index'),
                //     'permissions' => ['addon.index'],
                // ])
                ->registerItem([
