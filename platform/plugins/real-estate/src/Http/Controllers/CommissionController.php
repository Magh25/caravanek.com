...
use Exception;
use Botble\RealEstate\Tables\CommissionTable;
...
class CommissionController extends BaseController
{
    ...
    {
        page_title()->setTitle(trans('plugins/real-estate::commission.name'));
    ...
    public function edit($id, FormBuilder $formBuilder, Request $request)
    {
        ...
        page_title()->setTitle(trans('plugins/real-estate::commission.edit') . ' "' . $consult->name . '"');
